...
cetnostJmenaAll1000ge = FILTER cetnostJmenaAll BY count >= 1000;

-- Order data by count
dataOrdered = ORDER cetnostJmenaAll1000ge BY count DESC;

-- Get top 10
top10 = LIMIT dataOrdered 10;

-- Execute all the statements, show output, and store it back into HDFS
STORE top10 INTO '$OUTPUT'
    USING PigStorage(':');
