...
def first_task():
    ...
    vocabulary_size_eskymo = len(list(set(eskymo))) # vase reseni
    # test
...
def second_task():
    ...
    in_both_eskymo_prepos = list(set(eskymo) & set(prepos)) # vase reseni
    # test
...
def third_task():
    ...
    wordfreq_eskymo = dict(collections.Counter(eskymo)) # vase reseni
    # test
...
def fourth_task():
    ...
    backward_except_last = udubutubudu[:-1][::-1] # vase reseni
    # test
...
def fifth_task():
    ...
    skip2 = hymn_list[4:len(hymn_list):3] # vase reseni
